...
fluff=fp
field_line, br, bz, x1,x2,  i,0.0, rr,zz
...
interplot,fluff ,r,z,dr,dz,rr,zz,qinter1,rpl,zpl
oplot, sqrt(rpl^2+zpl^2), qinter1, linestyle=1
...
field_line, br, bz, x1,x2,  i,0.05, rr,zz
interplot,fluff ,r,z,dr,dz,rr,zz,qinter1,rpl,zpl
oplot, sqrt(rpl^2+zpl^2), qinter1, linestyle=2
...
field_line, br, bz, x1,x2,  i,0.05, rr,zz
interplot,fluff ,r,z,dr,dz,rr,zz,qinter1,rpl,zpl
oplot, sqrt(rpl^2+zpl^2), qinter1, linestyle=3


items=['fp','fm','feff','ftot']
