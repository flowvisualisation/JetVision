...
mag_torque= x1*fphi(*,0)
visc_torque= x1*divTphi(*,0)
...
window, title="ur / omega h  ", xsize=1000, ysize=800
fname='2012uromegah'
...
msmagnorm=-msmagpeak/hpeak
vrnorm=-vrpeak / omega / hpeak
msmagnorm=-smooth(msmagpeak/hpeak, 5)
msviscnorm=-smooth(msviscpeak/hpeak, 5)

!x.range=[1,20]
!y.range=0
plot, x1, vrnorm, linestyle=0, title='u!Dr!N/ '+greek('omega')+'!U2!Nh', xtitle='Radius (R)'
oplot, x1,  msmagnorm, linestyle=1
oplot, x1, msviscnorm, linestyle=2
items=['u!Dr!N/'+greek('omega')+'!U2!Nh','(JxB)!D'+greek('phi')+'!N/ '+greek('omega')+'!U2!Nh ','div T!D'+greek('phi')+'!N / '+greek('omega')+'!U2!Nh ']
