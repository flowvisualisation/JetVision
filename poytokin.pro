...
display, alog10(rho(0)), x1=x1,x2=x2,$
   title='log(!7q!3)'+ $
	   'Time (IDR)='+string(time(n)/2./!PI,format='(F8.1)'),$
	xrange=[2,20],yrange=[0,5],$
	ims=2, /hbar
...
!P.CHARSIZE=2
!P.MULTI=[0,1,3]
plot, rr,smooth(qinter1, 10, /edge_truncate), xrange=[2,20],xstyle=1,$
title="Poynting to kinetic flux ratio, !7r!3, at disk surface"
plot, rr,zz, xrange=[2,20],$
title="Disk Surface Height, z"
cut=80

plot, rr, smooth(qinter2, 10, /edge_truncate), $
title="!7l!3 !9m!X",$
xstyle=1,$
xrange=[2,20]
